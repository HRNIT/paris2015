    ...
    <div id="MobileNav" class="sidebar">
      <div id="MobileMenuListContainer"> <img id="MobileMenuCloseButton" src="img/menu/mobile-close-button.png" alt="X" onClick='HideMobileMenu()'>
        <ul id="MobileUl">
          ...
          <li><a href="contact" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Contact']);" title="Get In Touch" id="MobileMenuItemHovered">Get In Touch</a></li>
...
<nav id="DesktopMenu"> <a href="http://hrtechcongress.com" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'LogoHome']);">
  ...
  <ul id="DesktopMenuList">
    ...
    <li class="DesktopMenuItem DesktopMenuItemHovered" id="InfoDD"><a href="#" title="" >INFORMATION</a> 
      <!-- Information Dropdown -->
            ...
            <div class="ArrowUpDD"></div>
             <ul class="Dropdown" id="InformationDropdown">
                ...
                <a href="contact" title="Get in Touch" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Contact']);"><li style="color: #fff;">Get in Touch</li></a>
...
<div id="SocialWidgetWrapper"> 
  <a href="http://www.facebook.com/share.php?u=http://hrtechcongress.com/contact&title=HRTechCongress" target="_blank" onClick="_gaq.push(['_trackEvent', 'FloatingSocialShare', 'ExternalForward', 'Facebook']);">
  <div id="FacebookShare"><i class="fa fa-facebook"></i></div>
  </a>
   <a href="https://twitter.com/home?status=HR%20Tech%20World%20Congress%202015%20%E2%80%93%20Unleash%20Your%20People!%0Ahttp://hrtechcongress.com/contact%0A%23hrtechworld %23hrtech" class="twittershare twitter" data-text="HR Tech World Congress 2015 – Unleash Your People!" onClick="_gaq.push(['_trackEvent', 'FloatingSocialShare', 'ExternalForward', 'Twitter']);">
  <div id="TwitterShare"><i class="fa fa-twitter"></i></div>
  </a> <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=http://hrtechcongress.com/contact&title=HR Tech World Congress 2015 – Unleash Your People!" onClick="_gaq.push(['_trackEvent', 'FloatingSocialShare', 'ExternalForward', 'LinkedIn']);">
...
<header>
  <div id="HeaderInnerContainer">
    ...
    <a href="#ContactFormSection" onClick="_gaq.push(['_trackEvent', 'ContactPage', 'ScrollToAnchor', 'HeaderContactUs']);">
    <button class="FontRaleway">CONTACT US</button>
    </a> 
  
           <div id="ScrollDownHeaderLinkContainer">
             <a href="#Information" title="Scroll down for more..." >
                 <span>Scroll Down For More...</span>
                 <img id="ScrollDownIcon" src="img/contact/scroll-down-icon.png" alt="Scroll Down">
             </a>
         </div>
...
<a id="Information" style="position: relative; top: -8vw;"></a>
<!-- Form Section -->
  ...
  <div id="ContactInfoContainer">
    ...
    <div id="ContactGen">
      ...
      <p class="ContactText">General Inquiries<br />
        <a href="tel:003612011469" title="Call +36 1 201 1469">+36 1 201 1469</a><br />
        UK &amp; Ireland Number<br />
        <a href="tel:00442034689689" title="Call +44 20 34 689 689">+44 20 34 689 689</a> </p>
    </div>
    <div id="ContactMail">
