    ...
    <div id="MobileNav" class="sidebar">
      <div id="MobileMenuListContainer"> <img id="MobileMenuCloseButton" src="img/menu/mobile-close-button.png" alt="X" onClick='HideMobileMenu()'>
        <ul id="MobileUl">
          ...
          <li><a href="tickets" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Tickets']);" title="Get Tickets" id="MobileMenuItemHovered"><i class="fa fa-ticket"></i> Get Tickets</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<nav id="DesktopMenu"> <a href="http://hrtechcongress.com" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'LogoHome']);">
 ...
 <a href="tickets" title="Get Tickets" onClick="_gaq.push(['_trackEvent', 'Navigation', 'InternalForward', 'Tickets']);">
    <li class="DesktopMenuItem DesktopMenuItemHovered" id="DesktopGetTickets" style="color: #fff;"><i class="fa fa-ticket"></i> GET TICKETS</li>
    </a>
  </ul>
...
<div id="SocialWidgetWrapper"> 
  <a href="http://www.facebook.com/share.php?u=http://hrtechcongress.com/tickets&title=HRTechCongress" target="_blank" onClick="_gaq.push(['_trackEvent', 'FloatingSocialShare', 'ExternalForward', 'Facebook']);">
  <div id="FacebookShare"><i class="fa fa-facebook"></i></div>
  </a>
   <a href="https://twitter.com/home?status=HR%20Tech%20World%20Congress%202015%20%E2%80%93%20Unleash%20Your%20People!%0Ahttp://hrtechcongress.com/tickets%0A%23hrtechworld %23hrtech" class="twittershare twitter" data-text="HR Tech World Congress 2015 – Unleash Your People!" onClick="_gaq.push(['_trackEvent', 'FloatingSocialShare', 'ExternalForward', 'Twitter']);">
  <div id="TwitterShare"><i class="fa fa-twitter"></i></div>
  </a> <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=http://hrtechcongress.com/tickets&title=HR Tech World Congress 2015 – Unleash Your People!" onClick="_gaq.push(['_trackEvent', 'FloatingSocialShare', 'ExternalForward', 'LinkedIn']);">
...
<header>
  <div id="HeaderInnerContainer">
    <h1>Registration</h1>
    <p id="LightParagraph">Knowledge, Entertainment, Thought Leadership and a world of dinners, parties and events hosted by the world’s leading HR brands - be part of the fastest growing HR show in the world.</p>
    <a href="https://www.eiseverywhere.com//ereg/newreg.php?eventid=107774&" target="_blank" title="BOOK NOW" onClick="_gaq.push(['_trackEvent', 'TicketsPage', 'ExternalForward', 'HeaderBookNow']);">
    <button id="BookNowButton" class="FontRaleway">BOOK NOW</button>
    </a> </div>
         <div id="ScrollDownHeaderLinkContainer">
             <a href="#Tickets" title="Scroll down for more..." >
                 <span>Scroll Down For More...</span>
                 <img id="ScrollDownIcon" src="img/tickets/scroll-down-icon.png" alt="Scroll Down">
             </a>
         </div>
...
<!-- Tickets -->
<a id="Tickets" style="position: relative; top: -8vw;"></a>
<div id="TicketsMainContainer"> 
  ...
  <div id="OneDelegateMainContainer" class="TicketContainer">
    <div class="ContainerShadow">
      ...
      <div class="TicketsInfo">
        <p class="FontProximaNova">Regular tickets are priced at €1,190 per ticket. <span>LAST CHANCE to save €238.</span> Prices increase every two weeks. </p>
        <ul>
  ...
  <div id="ThreeDelegateMainContainer" class="TicketContainer">
    <div class="ContainerShadow">
      ...
      <div class="TicketsInfo">
        <p class="FontProximaNova">Regular tickets are priced at €1,190. <br>
          <span>Save €1,190 if you book 3 delegates before Sep 30th. </span></p>
        <ul>
          <li>Access to all stages</li>
          <li>Access to the exhibition area</li>
          <li>Access to the iRecruit co-located event</li>
  ...
  <div id="VIPDelegateMainContainer" class="TicketContainer">
    <div class="ContainerShadow">
      ...
      <div class="TicketsInfo">
        <p class="FontProximaNova">Enter your promo code to register for VIP tickets or special offers. </p>
        <ul>
          <li>Access to all stages</li>
          <li>Access to the exhibition area</li>
          <li>Access to the iRecruit co-located event</li>
