...
<div id="MainContent"> 
  ...
  <div id="BackToSpeakersContainer">
    <div id="BackToSpeakersInnerContainer"> <a href="../speakers" target="_parent" title="Back to Speakers"> <img src="../img/speakers/back-icon.png" alt="<"> <span class="FontLato">BACK TO SPEAKERS</span> </a> </div>
  </div>
...
<div id="GoTopImg"> <i class="fa fa-caret-up"></i> <img src="../img/back-to-top-mobile.png" alt="back to top"><br>
